...
import kr.pitb.controller.Ajax;
import kr.pitb.controller.Command;
import kr.pitb.controller.EmailCheckService;
import kr.pitb.controller.JoinService;
import kr.pitb.controller.LoginService;
import kr.pitb.controller.SelectAllService;
...
public class FrontController extends HttpServlet {
	...
	// 생성자 호출 -> init 메소드 -> 요청이 들어오길 대기
	// 오청이 들어오면 -> service 메소드 호출(빤복)
	// server stopped -> destroy(소멸) 메소드 호출

...
=======
<meta charset="UTF-8">
<title>Selfmaid Orange Dashboard_Log-in</title>
<!--     Fonts and icons     -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url('assets/img/우리의로고.png'); background-size: cover;">
              </div>
            </div>
                    ...
                    <div class="card-body">
                      <form role="form" class="text-start" action="Login" method="post">
                        ...
                        <p class="mt-4 text-sm text-center">
                          계정이 없으신가요?
                          <a href="sign-up.jsp" class="text-primary text-gradient font-weight-bold">회원가입</a>
                        </p>
                      </form>
                    </div>
                  </div>
					...
					<div class="row">
						<div
							...
							<div
								...
								style="background-image: url('assets/img/우리의로고.png'); background-size: cover;">
							</div>
						</div>
						<div
									...
									<form role="form" class="text-start" action="Login"
										...
										<div
											...
											<input class="form-check-input" type="checkbox"
												...
												class="form-check-label mb-0 ms-3" for="rememberMe">계정정보
												저장하기</label>
										</div>
										<div class="text-center">
											<button type="submit"
												class="btn bg-gradient-primary w-100 my-4 mb-2">들어가기</button>
										</div>
										<p class="mt-4 text-sm text-center">

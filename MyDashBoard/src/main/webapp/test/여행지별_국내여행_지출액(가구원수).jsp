...
<form onsubmit="return false" method="post">
    <h1>여행지별_국내여행_지출액(가구원수)(단위 : 만원)</h1>
    ...
    <input type = "hidden" name = "fileName" value ="20">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        $(".region-button").click(function () {
            ...
            switch (region) {
                case "서울":
                    regionData = [157, 199, 679];
                    break;
                case "부산":
                    regionData = [226, 205, 942];
                    break;
                case "대구":
                    regionData = [80, 87, 203];
                    break;
                case "인천":
                    regionData = [94, 121, 437];
                    break;
                case "광주":
                    regionData = [40, 43, 84];
                    break;
                case "대전":
                    regionData = [86, 64, 228];
                    break;
                case "울산":
                    regionData = [56, 62, 183];
                    break;
                case "세종":
                    regionData = [17, 19, 69];
                    break;
                case "경기":
                    regionData = [432, 522, 2069];
                    break;
                case "강원":
                    regionData = [433, 621, 2338];
                    break;
                case "충북":
                    regionData = [131, 237, 513];
                    break;
                case "충남":
                    regionData = [231, 380, 1112];
                    break;
                case "전북":
                    regionData = [212, 352, 699];
                    break;
                case "전남":
                    regionData = [238, 503, 1247];
                    break;
                case "경북":
                    regionData = [293, 434, 1265];
                    break;
                case "경남":
                    regionData = [253, 487, 1262];
                    break;
                case "제주":
                    regionData = [674, 1093, 3502];
                    break;
                default:
                    regionData = [];
                    break;

...
<form onsubmit="return false" method="post">
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    $('#regionButtons button').on('click', function () {
      ...
      switch (region) {
        case '서울':
          data.datasets[0].data = [74.7, 75.3];
          break;
        case '부산':
          data.datasets[0].data = [76, 78.3];
          break;
        case '대구':
          data.datasets[0].data = [72.7, 74.6];
          break;
        case '인천':
          data.datasets[0].data = [74.1, 74.3];
          break;
        case '광주':
          data.datasets[0].data = [81.3, 82.6];
          break;
        case '대전':
          data.datasets[0].data = [73, 74];
          break;
        case '울산':
          data.datasets[0].data = [76.2, 75.7];
          break;
        case '세종':
          data.datasets[0].data = [71.3, 73.1];
          break;
        case '경기':
          data.datasets[0].data = [75.4, 75.8];
          break;
        case '강원':
          data.datasets[0].data = [77, 77.3];
          break;
        case '충북':
          data.datasets[0].data = [74.4, 77];
          break;
        case '충남':
          data.datasets[0].data = [76.8, 76.3];
          break;
        case '전북':
          data.datasets[0].data = [80.4, 80.4];
          break;
        case '전남':
          data.datasets[0].data = [82.1, 80.6];
          break;
        case '경북':
          data.datasets[0].data = [76.3, 76.3];
          break;
        case '경남':
          data.datasets[0].data = [76.9, 77.7];
          break;
        case '제주':
          data.datasets[0].data = [79.6, 80.6];
          break;

...
<meta charset="UTF-8">
<<<<<<< HEAD
<title>Selfmade Orange Dashboard_sign-up
  </title>
  <!--     Fonts and icons     -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url('assets/img/기억_남산타워.jpg'); background-size: cover;">
              </div>
            </div>
                  ...
                  <div class="card-body">
                    <form role="form" action="Join" method="post">
                      ...
                      <div class="text-center">
                        <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg mainbutton mt-4 mb-0">가입</button>
                      </div>
                    </form>
                  </div>
...
>>>>>>> branch 'master' of https://github.com/2022-SMHRD-IS-BigData3/PythonIsTheBest.git
								...
								<div class="card z-index-0 fadeIn3 fadeInBottom">
									...
									<div class="card-footer text-center pt-0 px-lg-2 px-1">
										<p class="mb-2 text-sm mx-auto">
											계정이 이미 있으신가요? <a href="sign-in.jsp"
